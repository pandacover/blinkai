...
**Timeline Player**:
The in-browser player that plays the Assembled sequence of Stills/Clips with Voiceover; V1's Film delivery surface (not an MP4 download). V1 chrome is beat-aligned: play/pause, a scrubbable Shot beat rail, current Shot chip, and Voiceover caption.
_Avoid_: video player, exporter, slideshow (alone)
